...
async function loadVirtualModule(id) {
  switch (id) {
    ...
    case VIRTUAL_MODULES.startManifest:
      return await import('./_tanstack-start-manifest_v-DgW1FKTP.mjs');
...
function PWAUpdatePrompt({}) {
  ...
  return /* @__PURE__ */ jsx("div", { style: { position: "fixed", zIndex: 1e3 }, children: (offlineReady || needRefresh) && /* @__PURE__ */ jsxs(
    "div",
    {
      style: {
        position: "fixed",
      ...
      children: [
        /* @__PURE__ */ jsx("div", { children: offlineReady && !needRefresh ? /* @__PURE__ */ jsx("span", { children: "🎉 App ready to work offline!" }) : /* @__PURE__ */ jsx("span", { children: "🔄 New content available!" }) }),
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: "8px" }, children: [
          needRefresh && /* @__PURE__ */ jsx(
            "button",
            {
...
const appCss = "/assets/app-B1y5WCJo.css";
...
function RootDocument({
    ...
    return /* @__PURE__ */ jsxs("html", { children: [
      ...
      /* @__PURE__ */ jsxs("body", { children: [
        /* @__PURE__ */ jsxs("div", { style: {
          ...
          !isOnline && /* @__PURE__ */ jsx("div", { style: {
            background: "#ff9800",
            color: "white",
            padding: "8px",
            marginBottom: "10px",
            borderRadius: "4px"
          }, children: "📱 Offline Mode - Loading from cache..." }),
          "Loading database..."
        ] }),
  ...
  return /* @__PURE__ */ jsxs("html", { children: [
    /* @__PURE__ */ jsx("head", { children: /* @__PURE__ */ jsx(HeadContent, {}) }),
    /* @__PURE__ */ jsx("body", { children: /* @__PURE__ */ jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxs(PGliteProvider, { db, children: [
      !isOnline && /* @__PURE__ */ jsx("div", { style: {
        position: "fixed",
        top: 0,
        left: 0,
        ...
        textAlign: "center",
        zIndex: 1e3
      }, children: "📱 Offline Mode - App fully functional!" }),
      /* @__PURE__ */ jsxs("div", { style: {
        paddingTop: !isOnline ? "40px" : "0"
      }, children: [
        children,
...
const $$splitComponentImporter = () => import('./index-2bVb0NOF.mjs');
...
export { serverEntry as default, todoService as t };
